...
export default function Hero() {
  ...
  return (
    <section className="relative bg-slate-50 overflow-hidden min-h-[85vh] flex items-center">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#1a7066] rounded-full mix-blend-multiply filter blur-[100px] opacity-20"></div>
      <div className="absolute top-[20%] right-[-10%] w-[40%] h-[40%] bg-teal-300 rounded-full mix-blend-multiply filter blur-[100px] opacity-30"></div>
      <div className="absolute bottom-[-10%] left-[20%] w-[40%] h-[40%] bg-emerald-200 rounded-full mix-blend-multiply filter blur-[100px] opacity-40"></div>
